...
st.write(
    "Analyz Large Language Models to convert your code to any language of your choosing!!!"
)
...
with col2:
    ...
    st_ace(
        code_response, language=language_2, height=500, theme=theme_color, key="output"
    )
